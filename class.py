...
#self.analysis_summary_dict.clear()
    ...
    def svm_processing(self):
        ...
        fig_clusterPerformance = go.Figure(data=[go.Scatter(x=df_clusterPerformance.columns, y=df_clusterPerformance.loc["F1"])])
        ...
        #                  }
        #self.analysed_datasets_dict[expname]["Misclassification Analysis"] = {"Cluster performance" : SVM_dict.copy(), 
        #                                                                           "Total cluster performance":SVM_dict_total.copy()}
        #SVM_dict.clear()
        #return fig_clusterPerformance
        return SVM_dict, SVM_dict_total
